...
for i in range(1, 5):
    ...
    path_out = "C:/Users/mathe/Documents/Github-repos/fitna-study/dates_analysis/khit_date_clusters/clusters_threshold" + str(i) + "_cluster_count_" + str(count) + ".json"
    csv_out = "C:/Users/mathe/Documents/Github-repos/fitna-study/dates_analysis/khit_date_clusters/summary_threshold" + str(i) + "_cluster_count_" + str(count) + ".csv"
